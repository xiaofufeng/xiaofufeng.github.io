$(document).ready(function(){
  $("button#see_cards").click(function() {
    $("#how_to_match2").show(1000);
    $("#card_count2").show(1000);
    $("#card_count3").show(1000);
    $("#card_count4").show(1000);
  ...
  $("button#how_to_match2").click(function() {
    $("#match1").show(1000);
    $("#match2").show(1000);
    $("#match3").show(1000);
    $("#match4").show(1000);
...
$("button#knitwear").click(function() {
  $("#div1").hide(1000);
  $("#div2").hide(1000);
  $("#div3").hide(1000);
  $("#div4").hide(1000);
