...
$("#footer").show(1000);
         var table3_items = [];
                  ...
                  "https://api.airtable.com/v0/appENaVzPyNLQlumN/final_outer?api_key=keytLf7m73sOFf472&maxRecords=40&view=Grid%20view";
                  var table3_dataSet = [];
                  $.getJSON(airtable_read_endpoint, function(result) {
                         $.each(result.records, function(key,value) {
                             table3_items = [];
             ...
             var chart = c3.generate({
                                  ...
                                  color: {
                                          pattern: ['#1f77b4','#aec7e8','#aec7e8','#aec7e8','#aec7e8']
                                      },
                                  axis: {
